    ...
    <div class="container connexion">
        <form class="form-login" method="post" action="index.php?uc=connexion">
            ...
            <div class="login-wrap">
                ...
                L'attribut data-toggle contient le type d'événement qui va être lié à un bouton data-toggle=modal /* Bouton qui ouvre une fenêtre modale  -->
                    <a data-toggle="modal" href="v_connexion.php#myModal"> Mot de passe oublié ?</a>
                </div>
                <button class="btn btn-theme btn-block" type="submit" name="cmdAction" value="validerConnexion" title="Se connecter" onclick="document.getElementById('hdMdp').value = hex_sha512(document.getElementById('txtMdp').value);document.getElementById('txtMdp').value = ' ';"> <i class="fa fa-lock"></i> Se connecter</button>
                <!--  champ caché pour le mot de passe haché --> <input type="hidden" name="hdMdp" id="hdMdp" />
                <hr>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Entrez votre adresse mail pour réinitialiser votre mot de passe.</p> <input type="text" name="txtEmail" id="txtEmail" placeholder="Email" autocomplete="off" class="form-control placeholder-no-fix" />
                        </div>
